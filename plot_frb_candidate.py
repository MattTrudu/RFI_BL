...
def plot_candidate(filename,
    ...
    if (sk_flag is True):
        ax0_11.step(offbpass[~badchans], freqs[~badchans], linewidth = 2, color = "darkred", alpha = 0.5)
        ax0_11.step(onbpass[~badchans],  freqs[~badchans],linewidth = 2, color = "darkgreen", alpha = 0.9)
    else:
